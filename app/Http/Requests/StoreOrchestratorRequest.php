...
class StoreOrchestratorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'steps.*.provider_a' => ['nullable', 'string', 'in:openai,anthropic,gemini,openrouter,deepseek,ollama,lmstudio,bedrock,mock'],
            'steps.*.model_a' => ['nullable', 'string', 'max:255'],
            'steps.*.provider_b' => ['nullable', 'string', 'in:openai,anthropic,gemini,openrouter,deepseek,ollama,lmstudio,bedrock,mock'],
