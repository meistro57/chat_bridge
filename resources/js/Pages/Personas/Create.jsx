        ...
        <div className="min-h-screen p-8 font-['VT323'] bg-[#c0c0c0]">
            ...
            <div className="max-w-3xl mx-auto border-2 border-[#ffffff] shadow-[2px_2px_0px_0px_#000000]">
                <div className="bg-[#000080] text-white p-1 flex justify-between items-center px-2">
                    <span className="font-bold">PERSONA_CREATION_WIZARD.EXE</span>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            <label className="block text-lg">MODEL_OVERRIDE (OPTIONAL):</label>
                            <input 
                                type="text"
                                value={data.model}
                        ...
                        <div className="space-y-1">
                            <label className="block text-lg">TEMPERATURE (0.0 - 2.0):</label>
                            <input 
                                type="number"
                                step="0.1"
                                min="0"
                    ...
                    <div className="space-y-1">
                        ...
                        <textarea 
                            ...
                            placeholder="Define context, personality, and expertise..."
                        ></textarea>
                    ...
                    <div className="flex justify-between pt-4">
                        <Link href="/personas" className="bg-[#c0c0c0] px-4 py-2 border-2 border-[#ffffff] shadow-[1px_1px_0px_0px_#000000]">ABORT_MISSION</Link>
                        <button 
                            type="submit" 
                            disabled={processing}
                        ...
                        >
                            {processing ? 'UPLOADING...' : 'SAVE_PERSONA'}
                        </button>
                    </div>
                </form>
            </div>
